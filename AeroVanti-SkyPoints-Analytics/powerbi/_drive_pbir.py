"""
_drive_pbir.py — build the AeroVanti SkyPoints report from powerbi/_report_layout.json using pbir.

Called by build_report.sh (which does the env / abort-if-Desktop-running checks).
Idempotent: wipes and recreates powerbi/AeroVantiSkyPoints.Report each run.
"""
