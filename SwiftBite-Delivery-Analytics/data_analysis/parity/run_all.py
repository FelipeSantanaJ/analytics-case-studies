"""
run_all.py — run every analysis end to end and confirm SQL/Python parity.

Each data_analysis/python/NN_*.py computes its headline numbers on BOTH tracks
(pandas and DuckDB over the same curated parquet) and calls utils.parity(...),
which raises on any mismatch beyond tolerance.
